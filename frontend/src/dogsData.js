...
import AikaDiploma3l from "./assets/aika/Aika-diploma3-large.jpg";
...
import Teddy5l from "./assets/teddy/Teddy5-large.jpg";
...
const dogsData = [
  {
    ...
    lineage: "http://www.k9data.com/pedigree.asp?ID=1009638",
    status: "retired",
    titles: {
      pl: ["Champion Polski"],
  ...
  },
  {
    ...
    lineage: "http://www.k9data.com/pedigree.asp?ID=989487",
    status: "retired",
    titles: {
      pl: [
        "Champion Polski",
      ...
      en: [
        ...
        "Youth Champion of Hungary",
        "Crufts 2019 nomination",
      ],
    },
    type: {
      pl: "",
  ...
  },
  {
    ...
    lineage: "http://www.k9data.com/pedigree.asp?ID=989493",
    status: "retired",
    titles: {
      pl: ["Champion Polski"],
      en: ["Champion of Poland"],
...

  {
    ...
    lineage: "http://www.k9data.com/pedigree.asp?ID=1153187",
    status: "active",
    titles: {
      pl: ["Champion Polski", "Młodzieżowy Champion Polski"],
  ...
  },
  {
    ...
    tests: [
      ...
      "prcd-PRA - clear",
      "SD2 - clear",
      "EeBB - black with a yellow gene",
    ],
    lineage: "http://www.k9data.com/pedigree.asp?ID=1355471",
    status: "active",
    titles: {
      pl: ["Champion Polski"],
      en: ["Champion of Poland"],
